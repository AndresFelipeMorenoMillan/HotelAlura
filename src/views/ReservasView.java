...
public class ReservasView extends JFrame {
	...
	private ControlerReserva controlerReserva;
	/**
	...
	public ReservasView() {
		super("Reserva");
		this.controlerReserva = new ControlerReserva();
		...
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				calularValor(txtFechaEntrada, txtFechaSalida);
			}
		});
	...
	private void guardarReserva() {
		if(txtFechaEntrada.getDate() != null && txtFechaSalida.getDate() != null && !txtValor.equals("") && !txtFormaPago.getSelectedItem().toString().equals("")) {
			LocalDate fechaE = LocalDate.parse(((JTextField)txtFechaEntrada.getDateEditor().getUiComponent()).getText());
			LocalDate fechaS = LocalDate.parse(((JTextField)txtFechaSalida.getDateEditor().getUiComponent()).getText());
			Reservas reserva = new Reservas(fechaE, fechaS, txtValor.getText(), txtFormaPago.getSelectedItem().toString());
	...
	public void calularValor(JDateChooser fechaE, JDateChooser fechaS) {
